...
public class JDBCQuery {
	 ...
	 * @return
	 */
	public List<TopCategoryPojo> getTopCategoryWithChildrenCount()
    {
        List<TopCategoryPojo> parentCategoryList =new ArrayList<TopCategoryPojo>();
        ...
        )
        {
            ...
            while(topCategories.next())
            {
                ...
                TopCategoryPojo category = new TopCategoryPojo(topCategoryName, subCategoriesCount);
