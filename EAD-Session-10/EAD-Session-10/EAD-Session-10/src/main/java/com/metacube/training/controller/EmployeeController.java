...
import com.metacube.training.service.EmailSender;
...
public class EmployeeController {
	...
	public ModelAndView changePassword(@RequestParam("emailId") String email) {
		String msg = "Your password is: " + employeeService.getPassword(email);
		mailSender.sendSimpleMessage(email, "Change Password", msg);
