...
FROM Orders AS o, Product AS p, OrderProductRelation AS opr
...
FROM OrderProductRelation AS opr, Orders As o
...
FROM OrderProductRelation AS opr, Orders AS o, Product AS p
