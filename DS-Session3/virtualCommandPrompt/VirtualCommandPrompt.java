...
/**
 * @author Deekshika Sharma This class is used to access virtual command prompt
 */
public class VirtualCommandPrompt {
	...
	/**
	 * This method will perform various operations on virtual command prompt
	 */
	public static void virtualCommandPrompt() {
		...
		Directory currentDirectory = root; // the current directory initially
		...
		while (true) {
			...
			// This case will create a sub-directory into current directory
			case "mkdir":
			...
			// This case will shift to another directory
			case "cd":
				if (commandWords.length >= 2) {
			...
			// This case will back to the parent directory
			case "bk":
			...
			// This will display the list of sub-directories of a directory
			case "ls":
			...
			// This case will find the path of a sub-directory within a
			// directory
			case "find":
				path = ".\\";
			...
			// This method will display the current directory structure in tree
			// form
			case "tree":
				System.out.println(".");
	...
	/**
	 * This class will find the path of a directory within its parent directory
	 * 
	...
	private static String findPath(Directory currentDirectory,
		...
		if (currentDirectory.getName().equals(directoryToBeSearched)) {
			...
			for (Directory directory : currentDirectory.getListOfSubDirectory()) {
				...
				// this will recursively calls the method till reaches to last
				// sub directory
	...
	/**
	 * This method will print the directory structure in tree format
	 * 
	 * @param currentDirectory
	 * @param nesting
	 */
