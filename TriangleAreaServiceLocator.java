...
public class TriangleAreaServiceLocator extends org.apache.axis.client.Service implements com.area.TriangleAreaService {
    ...
    private java.lang.String TriangleArea_address = "http://localhost:8080/EAD-Session-6/services/TriangleArea";
    ...
    public com.area.TriangleArea getTriangleArea() throws javax.xml.rpc.ServiceException {
    ...
    public com.area.TriangleArea getTriangleArea(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.area.TriangleAreaSoapBindingStub _stub = new com.area.TriangleAreaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.area.TriangleArea.class.isAssignableFrom(serviceEndpointInterface)) {
                com.area.TriangleAreaSoapBindingStub _stub = new com.area.TriangleAreaSoapBindingStub(new java.net.URL(TriangleArea_address), this);
                _stub.setPortName(getTriangleAreaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://area.com", "TriangleAreaService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://area.com", "TriangleArea"));
        }
