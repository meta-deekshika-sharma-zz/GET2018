 ...
 * This class implements the Shape interface and used for performing operations on Square
 */
public class Square implements Shape{
	...
	public boolean isPointEnclosed(Point isEnclosedPoint) {
		...
		if (isEnclosedPoint.getX() >= point.getX() && isEnclosedPoint.getX() <= (point.getX() + width) && isEnclosedPoint.getY() >= point.getY() && isEnclosedPoint.getY() <= (point.getY() + width))
			return true;
		else
			return false;
	}
	...
	/**
	 * This method will return the distance from the origin of the screen to the origin of square
	 */
	@Override
