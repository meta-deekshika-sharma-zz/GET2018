...
public class Triangle implements Shape{
	...
	public boolean isPointEnclosed(Point isEnclosedPoint) {
		...
		double area = calculateAreaOfTriangleByCornerPoints(point1, point2, isEnclosedPoint) + calculateAreaOfTriangleByCornerPoints(this.point, point2, isEnclosedPoint) + calculateAreaOfTriangleByCornerPoints(point1, this.point, isEnclosedPoint);
	...
	/**
	 * This method will return the distance from the origin of the screen to the origin of triangle
	 */
	@Override
